...
J'ai pris plaisir à le développer, mais il est relativement basique, et je souhaite consacrer plus de temps sur la pratique de sujets que je suis en train d'apprendre (Spring, par exemple). 
...
Le jar exéctuable est [--> Ici <--](boggle-1.0.jar)
